...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{problem-heavy-memory.png}
...
\subsection{Full patch (authoritative diff)}

The following listing reproduces \texttt{kernel/patches/0001-pressurepause.patch} verbatim (compile \texttt{Report.tex} from the repository root so the path resolves).

\begin{codebox}[Full unified diff: kernel/patches/0001-pressurepause.patch]
\lstinputlisting[style=patchstyle]{kernel/patches/0001-pressurepause.patch}
\end{codebox}
