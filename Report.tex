...
\textbf{Pending:} \texttt{uname -r} output confirming \texttt{6.8.12-baseline} after reboot is not yet included. Boot verification should be completed before the final submission; the fallback Ubuntu entry remains available if the custom kernel fails.
